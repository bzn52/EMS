        ...
        <div class="card">
          ...
          <?php if (!$result || $result->num_rows === 0): ?>
            <div class="empty-state">
              ...
              <a href="events/create.php" class="btn btn-sm"
                style="margin-top: 1rem; width: auto; display: inline-block;">Create First Event</a>
            </div>
          <?php else: ?>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <div style="display: flex; gap: 0.5rem; justify-content: center; flex-wrap: wrap;">
                          <a href="events/view.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm"
                            style="background: #e0e7ff; color: #4338ca; width: auto; padding: 0.375rem 0.75rem; font-size: 0.813rem;"><i
                              class="fas fa-eye"></i> View</a>
                          <a href="events/edit.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm"
                            style="background: #dbeafe; color: #1e40af; width: auto; padding: 0.375rem 0.75rem; font-size: 0.813rem;"><i
                          ...
                          <?php if ($row['status'] !== 'approved'): ?>
                            <form method="post" action="events/approve.php" style="display: inline; margin: 0;">
                              ...
                              <button type="submit" class="btn btn-sm btn-success"
                                style="width: auto; padding: 0.375rem 0.75rem; font-size: 0.813rem;"><i
                          ...
                          <?php endif; ?>
                          <a href="events/delete.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm btn-danger"
                            style="width: auto; padding: 0.375rem 0.75rem; font-size: 0.813rem;"
