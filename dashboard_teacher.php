            ...
            <?php while ($row = $myEvents->fetch_assoc()): ?>
              <article class="card">
                ...
                <div class="card-footer">
                  <a href="events/view.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm btn-outline"><i
                      class="fas fa-eye"></i> View</a>
                  <a href="events/edit.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm"><i class="fas fa-edit"></i>
                    Edit</a>
          ...
          <div class="card">
            <div class="empty-state">
              ...
              <a href="events/create.php" class="btn btn-sm"
                style="margin-top: 1rem; width: auto; display: inline-block;">Create Event</a>
            </div>
          </div>
        <?php else: ?>
          <div class="event-grid">
            <?php while ($row = $allEvents->fetch_assoc()):
              ...
              <article class="card">
                ...
                <div class="card-footer">
                  <a href="events/view.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm" style="width: 100%;">View
                    Details</a>
                  <?php if ($isOwner): ?>
                    <a href="events/edit.php?id=<?= (int) $row['id'] ?>" class="btn btn-sm btn-outline"><i
